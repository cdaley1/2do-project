...
class MasterTableViewController: UITableViewController {
    ...
    func refresh(){
        ...
        //println(userDefaults.objectForKey("itemList"))
        
        
        let itemListFromUserDefaults:NSMutableArray? = userDefaults.objectForKey("item_List") as? NSMutableArray
    ...
    override func viewDidAppear(animated: Bool) {
        ...
        let item_ListFromUserDefaults:NSMutableArray? = userDefaults.objectForKey("item_List") as? NSMutableArray
        
        if ((item_ListFromUserDefaults) != nil){
            toDoItems = item_ListFromUserDefaults!
        }
    ...
    override func tableView(tableView: UITableView, cellForRowAtIndexPath indexPath: NSIndexPath) -> UITableViewCell {
        ...
        let toDoItem :NSDictionary = toDoItems.objectAtIndex(indexPath.row).mutableCopy() as! NSDictionary
    ...
    override func tableView(tableView: UITableView, commitEditingStyle editingStyle: UITableViewCellEditingStyle, forRowAtIndexPath indexPath: NSIndexPath) {
        ...
        if(editingStyle == UITableViewCellEditingStyle.Delete){
            ...
            mutableItemList.removeObject(toDoItems.objectAtIndex(indexPath.row))
